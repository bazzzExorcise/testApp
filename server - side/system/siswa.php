...
while( $rows = mysqli_fetch_assoc($sql)) {
  ...
  "<div class='flex w-full gap-2 justify-between'>
    ...
    <div class='flex items-center font-extrabold whitespace-nowrap gap-1'>
      <a class='update-pop rounded-lg border-2 border-black bg-green-400 px-3 py-1 text-sm' href='../system/edit.php?id=" . $rows['id'] . "' nama='".$rows['username']."' id='" . $rows['id'] . "' kelas='".$rows['kelas']."' jurusan='". $rows['jurusan'] ."' nomor='".$rows['nomor']."' pass='" . $rows['password'] . "' >Edit</a>
